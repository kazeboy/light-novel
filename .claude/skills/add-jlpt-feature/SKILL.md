---
name: add-jlpt-feature
description: Extends Japanese language and JLPT study features. Use when adding a new furigana mode, vocabulary export, Anki deck generation, or any feature that works with the Japanese text pipeline.
disable-model-invocation: true
argument-hint: <description of the Japanese/JLPT feature to add>
---
