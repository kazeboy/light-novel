---
name: add-source
description: Scaffolds a new novel scraper source. Use when adding support for a new website, building a new scraper class, or extending the sources/ layer.
disable-model-invocation: true
argument-hint: <site name or URL to support>
---
