---
name: debug-scraper
description: Diagnoses and fixes scraping failures. Use when a source returns empty content, wrong chapter counts, broken metadata, or any unexpected scraper behaviour.
disable-model-invocation: true
argument-hint: <site name or description of the failure>
---
